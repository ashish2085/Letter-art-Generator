...
class ASCIIArtGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String str=put.nextLine();
       // System.out.println();
        artGen.printTextArt(str, ASCIIArtGenerator.ART_SIZE_MEDIUM);
        System.out.println();
        
        System.out.println();
        System.out.println("Enter another string which you want to print:\t");
        String str1=put.nextLine();
        artGen.printTextArt(str1, ASCIIArtGenerator.ART_SIZE_SMALL, ASCIIArtFont.ART_FONT_MONO,"@");
        System.out.println();
